...
Fatos Ismali comment: In this fork (thinkgradient's fork) image_not_results.csv file contains the output of the Microsoft Computer Vision API classification result. Please update the duck_labels and rabbit_labels below accordingly. 
